...
<head>
    ...
    <title>Login &mdash; SILACAK</title>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets/img/silacak.jpeg') }}" alt="logo" width="100"
                                class="shadow-light " style="padding:2px;background: white;border-radius:10px">
                        </div>
