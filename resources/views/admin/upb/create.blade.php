        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-book"></i> Tambah Upb</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.upb.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="kode_upb" value="{{ old('kode_upb') }}" placeholder="Masukkan  kode UPB"
                        ...
                        <div class="row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan nama Upb"
                                        class="form-control" required>
                                    @error('name')
                                    <div class="invalid-feedback" style="display: block">
                                        {{ $message }}
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    <label>lokasi</label>
                                    <input type="text" name="lokasi" value="{{ old('lokasi') }}" placeholder="Masukkan lokasi"
                                        class="form-control" required>
                                    @error('lokasi')
                                    <div class="invalid-feedback" style="display: block">
                                        {{ $message }}
