        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-book"></i> Tambah Mutasi Kendaraan</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.mutasi-kendaraan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row" style="display: none">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="" class="form-control" placeholder="Masukan Keterangan..." required cols="30"pla rows="10"></textarea>
